...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(AccountTab)` | `/(CartTab)` | `/(CategoryTab)` | `/(HomeTab)` | `/(tabs)` | `/AccountScreen` | `/AllCategoriesScreen` | `/CartScreen` | `/FilterScreen` | `/Header` | `/Menu` | `/SearchScreen` | `/_sitemap` | `/explore`;
