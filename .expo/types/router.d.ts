...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(AccountTab)` | `/(CartTab)` | `/(CategoryTab)` | `/(HomeTab)` | `/(tabs)` | `/AccountScreen` | `/CartScreen` | `/CategoryScreen` | `/Header` | `/Menu` | `/ProductScreen` | `/SearchScreen` | `/_sitemap` | `/explore`;
